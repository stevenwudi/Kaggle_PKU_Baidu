...
albu_train_transforms=[
    ...
    dict(type='RandomBrightnessContrast',brightness_limit=0.3, contrast_limit=0.3,p=0.3),
    # dict(type='oneof',
    #      transforms=[dict(type='GaussianBlur',blur_limit=20,p=0.3),
    #                  dict(type='GaussNoise',var_limit=(10,50),p=0.5)],
    #      )
    dict(type='GaussianBlur',blur_limit=20,p=0.3),
    dict(type='GaussNoise',var_limit=(10,50),p=0.5),
]
train_pipeline = [
    ...
    dict(type='Albu_transform',transforms=albu_train_transforms),
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Resize', img_scale=(1664, 576), keep_ratio=True),
            # dict(type='Resize', img_scale=(2199, 799), keep_ratio=True),
            #dict(type='RandomFlip', flip_ratio=0.5),
            dict(type='RandomFlip', flip_ratio=0), ## for horizontal flip tesing
            dict(type='Normalize', **img_norm_cfg),
            dict(type='Pad', size_divisor=32),
...
data_root = '/data/home/yyj/code/kaggle/new_code/Kaggle_PKU_Baidu/data/pku_data/'
data = dict(
    imgs_per_gpu=1,
    workers_per_gpu=2,
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'kaggle_apollo_combined_6692_origin.json',
...
log_level = 'INFO'
work_dir = '/data/home/yyj/code/kaggle/new_code/Kaggle_PKU_Baidu/output2/'
# load_from = '/data/home/yyj/code/kaggle/Kaggle_PKU_Baidu-master/output/trimmed_htc_hrnetv2p_w48_20e_kaggle_pku.pth'

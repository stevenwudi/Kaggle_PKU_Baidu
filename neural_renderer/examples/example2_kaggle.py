...
class Model(nn.Module):
    def __init__(self, filename_obj, filename_ref):
        ...
        # load .obj
        vertices, faces = load_json_car_model(filename_obj)
...
def main():
    ...
    parser.add_argument('-io', '--filename_obj', type=str, default='/data/Kaggle/pku-autonomous-driving/car_models_json/biyadi-tang.json')
    parser.add_argument('-ir', '--filename_ref', type=str, default=os.path.join(data_dir, 'example2_ref.png'))
    parser.add_argument('-oo', '--filename_output_optimization', type=str, default=os.path.join(data_dir, 'example2_optimization_kaggle.gif'))
    parser.add_argument('-or', '--filename_output_result', type=str, default=os.path.join(data_dir, 'example2_result_kaggle.gif'))

...
class LoadAnnotations(object):
    ...
    def __init__(self,
        ...
        self.with_camera_rot = with_camera_rot
    ...
    def _load_camera_rot(self, results):
        results['Mat'] = np.array(results['ann_info']['Mat'])
        return results
    ...
    def __call__(self, results):
        ...
        if self.with_camera_rot:
            results = self._load_camera_rot(results)

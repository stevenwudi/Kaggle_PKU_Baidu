...
def pose_similarity(dt, gt, shape_sim_mat):
    ...
    # rotation similarity
    dt_car_rot = euler_angles_to_quaternions(dt[:, :3])
    gt_car_rot = euler_angles_to_quaternions(gt[:, :3])
...
class Detect3DEval(object):
    ...
    def __init__(self, args):
        ...
        self.image_list = self._checker_intersection_one_image(args.test_dir, args.gt_dir)
        self.params = Params(simType=args.simType)

    def _checker_intersection_one_image(self, res_folder, gt_folder):

...
def create_lock(lock_name):
    fd = open(lock_name, mode="w", encoding="utf-8")
    fd.close()
...
def parse_args():
    ...
    parser.add_argument('--tmpdir', default='/data/cyh/kaggle/tmp_output', help='tmp dir for writing some results')
...
def main():
    args = parse_args()
    args.out = "/data/Kaggle/cwx_data/all_yihao069e100s5070_resume92Dec24-08-50-226141a3d1/validation_all_yihao069e100s5070_resume92Dec24-08-50-226141a3d1.pkl"

...
checkpoint_file ='/data/Kaggle/wudi_data/work_dirs/htc_hrnetv2p_w48_20e_kaggle_pku_Nov13-11-15-55/epoch_1.pth'
...
for i in tqdm(range(len(img_names))):
    ...
    show_result_kaggle_pku(img, result, CocoDataset.CLASSES, show=False, out_file=os.path.join(out_dir, img_names[i]))
